...
#19 Порахуй голосні та приголосні. Функція повинна повернути словник:
def count_vow_con(word):
    ...
    res_dict = {"vowels": vow,
                "consonants": con}
    return res_dict
print(count_vow_con("listen"))

#20 Напиши функцію, яка поверне список імен усіх студентів із найвищою оцінкою:
students = [
    {"name": "Anna", "score": 95},
    {"name": "Ivan", "score": 81},
    {"name": "Olena", "score": 90},
